            ...
            {enrolledCourses.map((course, index) => (
              <tr key={index} className='border-b border-gray-500/20'>
                ...
                <td className='px-4 py-3 space-x-2'>
                  {/* Go To Course */}
                  <button
                    className='px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 text-white rounded cursor-pointer'
                    onClick={() => navigate('/player/' + course._id)}
                  >
                    {progressArray[index] && progressArray[index].lectureCompleted / progressArray[index].totalLectures === 1 ? 'Completed' : 'Go To Course'}
                  </button>

                  {/* View Docs */}
                  <button
                    className='px-3 sm:px-5 py-1.5 sm:py-2 bg-green-600 text-white rounded cursor-pointer'
                    onClick={() => navigate('/course/' + course._id + '/docs')}
                  >
                    View Docs
                  </button>
                  ...
                  {/* Take Quiz */}
                  <button
                    className='px-3 sm:px-5 py-1.5 sm:py-2 bg-purple-600 text-white rounded cursor-pointer'
